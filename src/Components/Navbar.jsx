...
const Navbar = () => {
  ...
  return (
    <div className="navbar py-7 flex items-center justify-between bg-zinc-800 rounded-b-2xl selection:bg-violet-500">
      ...
      >
        <li>
          <a href="#" className="sm:text-lg transition duration-300 hover:text-violet-500 hover:scale-105 text-base font-medium">
            Beranda
          </a>
        </li>
        <li>
          <a href="#" className="sm:text-lg transition duration-300 hover:text-violet-500 text-base font-medium">
            Tentang
          </a>
        </li>
        <li>
